...
##---------------------------------------------------------------------------------------------
 ...
 set logfile = `printf "signif-sigmass-%d.log" $sig_mass`
 ...
 echo running root
 echo  rundemosignif.c\(\"$wsrootfile\",0,$ntoy,\"$fulloutfilebase\"\) 
 root -b -q rundemosignif.c\(\"$wsrootfile\",0,$ntoy,\"$fulloutfilebase\"\) >& $finaldir/$logfile
